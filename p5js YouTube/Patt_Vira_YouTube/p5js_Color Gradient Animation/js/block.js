class Block {
  ...
  display () {
   // let x = 300;
    this.setBlockColor(0, this.x, this.y, this.h, this.c1, this.c2, this.c3);
    this.setBlockColor(this.x, width, this.y, this.h, this.c1, this.c2, this.c3);
  }
  ...
  setBlockColor (min, max, y, h, c1, c2, c3) {
    let x = 0.5;
    let range = max - min;
